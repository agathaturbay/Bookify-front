...
describe('CredentialsService', () => {
  ...
  describe('setCredentials', () => {
    it('should authenticate user if credentials are set', () => {
      // Act
      credentialsService.setCredentials({ username: 'me', token: '123', email: 'lala@gmail.com', role: 'admin' });
    ...
    it('should persist credentials across sessions', () => {
      // Act
      credentialsService.setCredentials({ username: 'me', token: '123', email: 'lala@gmail.com', role: 'admin' }, true);
